        ...
        <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id="home">
            <div className='p-2 flex-1 flex flex-col items-start justify-center gap-6'>
                ...
                <p className='text-[2.5rem] md:text-[4.5rem] font-bold tracking-wide text-headingColor'>
                    Dimana Setiap Rasanya {" "}
                    <span className='text-orange-600 text-[3rem] lg:-[5rem]'>Penuh Dengan Cerita</span>
                </p>

                <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Pellentesque euismod, nisi vel consectetur
                    consectetur, nisi velit egestas nisi, vel
                    consectetur nisi nisi velit egestas nisi.
                </p>
